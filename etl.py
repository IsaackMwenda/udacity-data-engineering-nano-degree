...
def process_log_file(cur, filepath):
    ...
    time_data = ([ts, ts.dt.hour, ts.dt.day, ts.dt.isocalendar().week, ts.dt.month, ts.dt.year, ts.dt.day_name()])
    ...
    # load user table
    user_df = t[['userId', 'firstName', 'lastName', 'gender', 'level']].drop_duplicates()
